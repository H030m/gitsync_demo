// Server-side noise filter for inbound Discord messages.
//
// First pass happens in the forwarder bot (cheaper — drops obvious junk before
// hitting our HTTPS endpoint at all). This is the second pass run by
// `discordMessageIngest`. The rules MUST stay in sync with the forwarder's
// `shouldKeepMessage`. See MEMORY.md 2026-05-26 "Discord messages filtered at
// both forwarder and ingest function".
